 ...
 * @version $Id: EmailClient.js 15392 2013-08-06 05:56:20Z wsmits $
...
GO.email.EmailClient = function(config){
	...
	this.messagesStore = new GO.data.JsonStore({
		...
		totalProperty: 'total',
		id: 'uid',
		fields:['uid','icon','flagged','has_attachments','seen','subject','from','sender','size','date', 'x_priority','answered','forwarded','account_id','mailbox','arrival','arrival_time','date_time'],
		remoteSort: true
	});
